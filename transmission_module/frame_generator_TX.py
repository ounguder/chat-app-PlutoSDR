import numpy as np
from utils.symbol_conversion import letters_to_pam, pam_to_qam3, pam_to_qam
...
Function description:
    ...
    on the modulation_type. As first operation at this stage, characters are converted into binary format and then 4PAM symbols. For QAM3 and 4QAM, 4PAM symbols are mapped over related symbols.
...
Args:
        ...
        modulation_type (str): Modulation type for encoding symbols (e.g., "4QAM", "QAM3").
        ...
        for i in range(number_of_data_frames + 1):
            if i == number_of_data_frames:
                ...
                if mod_type == '4QAM':
                    ...
                    data_symbols = pam_to_qam3(letters_to_pam(data))
                else:
